  ...
  return (
    <div>
      ...
      <div
        className={
          scroll
            ? "h-16 w-full fixed flex transition items-center ease-in-out duration-500 bg-white rounded-sm bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-55 z-20"

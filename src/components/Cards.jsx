...
const Cards = ({data, reference}) => {
  return (
    <motion.div drag dragConstraints={reference} whileDrag={{scale : 1.2}} dragElastic={0.1} className='relative w-60 h-72 rounded-[45px] bg-black/60 text-white px-8 py-10 overflow-hidden'>
      <FaRegFileAlt/>
